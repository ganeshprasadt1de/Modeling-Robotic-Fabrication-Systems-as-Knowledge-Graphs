...
A link shows how two nodes are connected.

Examples:

```text
System hasRobot Robot2
System makesProduct TimberSlabWithColumn
Robot2 hasTool GripperTool
Robot2 hasExternalAxis TransferRail
Robot2 doesProcess MovePlateStep
Robot2 doesProcess MoveReinforcementStep
Robot2 doesProcess PlaceColumnStep
TimberSlabWithColumn hasComponent ReinforcementBetweenPlates
ReinforcementBetweenPlates hasMaterial BeechLVL
ReinforcementBetweenPlates isBetween BottomPlate and TopPlate
Robot2GripSensor checksProcess MoveReinforcementStep
```
